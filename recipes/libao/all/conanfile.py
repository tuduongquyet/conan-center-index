...
class LibaoConan(ConanFile):
    name = "libao"
    url = "https://github.com/conan-io/conan-center-index"
    homepage = "https://gitlab.xiph.org/xiph/libao"
    license = "GPL-2.0-only"
    description = "Libao is a cross-platform audio library that allows programs to output audio using a simple API on a wide variety of platforms"
    topics = ("ao", "audio", "libao")
    ...
    def package(self):
        ...
        if self.settings.compiler == "Visual Studio" and self.options.shared:
            tools.rename(os.path.join(self.package_folder, "lib", "ao.dll.lib"),
                         os.path.join(self.package_folder, "lib", "ao.lib"))
    ...
    def package_info(self):
        ...
        self.cpp_info.names["pkg_config"] = "libao"
        self.cpp_info.set_property("cmake_find_mode", "both")
        self.cpp_info.set_property("cmake_file_name", "libao")
        self.cpp_info.set_property("cmake_target_name", "libao::libao")

        self.cpp_info.names["cmake_find_package"] = "libao"
        self.cpp_info.names["cmake_find_package_multi"] = "libao"

        self.cpp_info.libs = ["ao"]
