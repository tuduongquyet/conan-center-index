...
class LibebuConan(ConanFile):
    name = "libebu"
    url = "https://github.com/conan-io/conan-center-index"
    homepage = "http://green.ribbon.to/~ikazuhiro/dic/ebu.html"
    license = "BSD-3-Clause"
    description = "libebu is the library for managing EB/EB-G/EB-XA ebooks"
    topics = ("eb", "ebooks", "libebu", "epwing")
    ...
    def requirements(self):
        ...
        if self.options.enable_libdeflate:
    ...
    def _configure_autotools(self):
        ...
        args = [
            ...
            "--enable-libdeflate={}".format(
                yes_no(self.options.enable_libdeflate)),
            "--enable-samples=no",
        ...
        if self.options.enable_libdeflate:
            args.append(
                "--with-libdeflate-includes={}".format(tools.unix_path(os.path.join(
                    self.dependencies["libdeflate"].package_folder, "include")))
            )
            args.append(
                "--with-libdeflate-libraries={}".format(tools.unix_path(os.path.join(
                    self.dependencies["libdeflate"].package_folder, "lib"))),
            )
    ...
    def package(self):
        ...
        if self.settings.compiler == "Visual Studio" and self.options.shared:
            tools.rename(os.path.join(self.package_folder, "lib", "ebu.dll.lib"),
                         os.path.join(self.package_folder, "lib", "ebu.lib"))
    ...
    def package_info(self):
        ...
        self.cpp_info.names["pkg_config"] = "libebu"
        self.cpp_info.set_property("cmake_find_mode", "both")
        self.cpp_info.set_property("cmake_file_name", "libebu")
        self.cpp_info.set_property("cmake_target_name", "libebu::libebu")

        self.cpp_info.names["cmake_find_package"] = "libebu"
        self.cpp_info.names["cmake_find_package_multi"] = "libebu"

        self.cpp_info.libs = ["ebu"]
